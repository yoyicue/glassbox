...
> 仍缺失（无真正的 multi-sample outcome 评测）；第②层正在修正但地板仍不诚实（2026-06-06
...
> 仍来自 coverage 全 0 的旧路径，n≥5 采样还没收口）；第③层部分修正（2026-06-05：`compare_benchmarks` 已 gate coverage/process 回归和有样本时的
