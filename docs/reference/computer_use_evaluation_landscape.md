...
> Stage Manager/windowed Settings 状态；这些会改变 observation distribution，应作为单独 a11y-mode
> eval cell 报告，而不是默认 floor。第③层部分修正（2026-06-05：`compare_benchmarks` 已 gate
