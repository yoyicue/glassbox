...
> `expected_state_coverage=0.976`、`recoveries=0`，失败样本缺 `隐私与安全性`；仍缺人类对照、
> 多 App/语言扩展和 floor 冻结。去敏 snapshot 已提交为
> `skills/regression/fixtures/l2_settings_expected_state_snapshot.json`，并有 smoke 验证其 schema、
> n≥5、coverage 非零和 coverage-regression gate。第②层正在修正但地板仍不诚实（2026-06-06
