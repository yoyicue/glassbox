...
> 仍是 2026-06-01 的 5/5 completion floor，coverage-bearing snapshot 尚未升格为 completion floor）；第③层部分修正（2026-06-05：`compare_benchmarks` 已 gate coverage/process 回归和有样本时的
