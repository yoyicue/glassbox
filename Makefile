...
IPHONE_SETTINGS_BASELINE ?= skills/regression/fixtures/iphone_settings_baseline.json
...
regression-gate:
	...
	$(COMPUTER_USE_SUCCESS_RATE) validate "$(IPHONE_SETTINGS_BASELINE)"
	...
	uv run pytest skills/smoke/test_computer_use_regression_gate.py skills/smoke/test_human_baseline.py \
		...
		skills/smoke/test_iphone_settings_floor.py \
